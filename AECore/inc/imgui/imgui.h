...
struct ImColor;                    // Helper functions to create a color that can be converted to either unsigned or float4 (*OBSOLETE* please avoid using)
...
// **Avoid storing ImColor! Store either unsigned of ImVec4. This is not a full-featured color class. MAY OBSOLETE.
...
struct ImFontAtlas
{
    ...
    // NB: Make sure that your string are UTF-8 and NOT in your local code page. In C++11, you can create UTF-8 string literal using the unsigned char"Hello world" syntax. See FAQ for details.
